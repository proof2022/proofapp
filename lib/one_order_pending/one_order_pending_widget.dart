...
import 'one_order_pending_model.dart';
export 'one_order_pending_model.dart';

class OneOrderPendingWidget extends StatefulWidget {
  const OneOrderPendingWidget({
    Key? key,
    this.post,
  }) : super(key: key);
  ...
  @override
  _OneOrderPendingWidgetState createState() => _OneOrderPendingWidgetState();
}

class _OneOrderPendingWidgetState extends State<OneOrderPendingWidget> {
  late OneOrderPendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OneOrderPendingModel());
  }
